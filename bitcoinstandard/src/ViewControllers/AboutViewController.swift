...
class AboutViewController : UIViewController {
    ...
    private func setActions() {
        blog.button.tap = { [weak self] in
            self?.presentURL(string: "https://bitcoinstandard.com/blog/")
        }
        twitter.button.tap = { [weak self] in
            self?.presentURL(string: "https://twitter.com/bitcoinstandard")
        }
        reddit.button.tap = { [weak self] in
            self?.presentURL(string: "https://reddit.com/r/bitcoinstandard/")
        }
        //TODO - find this link
        terms.tap = { [weak self] in
            self?.presentURL(string: "https://bitcoinstandard.com/terms?")
        }
        privacy.tap = { [weak self] in
            self?.presentURL(string: "https://bitcoinstandard.com/privacy-policy")
        }
    }
